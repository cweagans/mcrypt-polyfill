...
if (extension_loaded('mcrypt') && getenv('USE_RUNKIT') == TRUE) {
    ...
    runkit_constant_remove('MCRYPT_ENCRYPT');
    runkit_constant_remove('MCRYPT_DECRYPT');
    runkit_constant_remove('MCRYPT_DEV_RANDOM');
    runkit_constant_remove('MCRYPT_DEV_URANDOM');
    runkit_constant_remove('MCRYPT_RAND');
    runkit_constant_remove('MCRYPT_3DES');
    runkit_constant_remove('MCRYPT_ARCFOUR_IV');
    runkit_constant_remove('MCRYPT_ARCFOUR');
    runkit_constant_remove('MCRYPT_BLOWFISH');
    runkit_constant_remove('MCRYPT_BLOWFISH_COMPAT');
    runkit_constant_remove('MCRYPT_CAST_128');
    runkit_constant_remove('MCRYPT_CAST_256');
    runkit_constant_remove('MCRYPT_CRYPT');
    runkit_constant_remove('MCRYPT_DES');
    runkit_constant_remove('MCRYPT_ENIGNA');
    runkit_constant_remove('MCRYPT_GOST');
    runkit_constant_remove('MCRYPT_LOKI97');
    runkit_constant_remove('MCRYPT_PANAMA');
    runkit_constant_remove('MCRYPT_RC2');
    runkit_constant_remove('MCRYPT_RIJNDAEL_128');
    runkit_constant_remove('MCRYPT_RIJNDAEL_192');
    runkit_constant_remove('MCRYPT_RIJNDAEL_256');
    runkit_constant_remove('MCRYPT_SAFER64');
    runkit_constant_remove('MCRYPT_SAFER128');
    runkit_constant_remove('MCRYPT_SAFERPLUS');
    runkit_constant_remove('MCRYPT_SERPENT');
    runkit_constant_remove('MCRYPT_THREEWAY');
    runkit_constant_remove('MCRYPT_TRIPLEDES');
    runkit_constant_remove('MCRYPT_TWOFISH');
    runkit_constant_remove('MCRYPT_WAKE');
    runkit_constant_remove('MCRYPT_XTEA');
    runkit_constant_remove('MCRYPT_IDEA');
    runkit_constant_remove('MCRYPT_MARS');
    runkit_constant_remove('MCRYPT_RC6');
    runkit_constant_remove('MCRYPT_SKIPJACK');
    runkit_constant_remove('MCRYPT_MODE_CBC');
    runkit_constant_remove('MCRYPT_MODE_CFB');
    runkit_constant_remove('MCRYPT_MODE_ECB');
    runkit_constant_remove('MCRYPT_MODE_NOFB');
    runkit_constant_remove('MCRYPT_MODE_OFB');
    runkit_constant_remove('MCRYPT_MODE_STREAM');
}
